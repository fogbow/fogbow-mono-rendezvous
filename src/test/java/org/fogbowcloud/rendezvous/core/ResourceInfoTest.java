...
public class ResourceInfoTest {
    ...
    public void testNullId() {
        new ResourcesInfo(null, "value1", "value2", "value3", "value4", flavors);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testEmptyId() {
        new ResourcesInfo("", "value1", "value2", "value3", "value4", flavors);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testNullCpuIdle() {
        new ResourcesInfo("id", null, "value2", "value3", "value4", flavors);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testNullCpuInUse() {
        new ResourcesInfo("id", "value1", null, "value3", "value4", flavors);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testNullMemIdle() {
        new ResourcesInfo("id", "value1", "value2", null, "value4", flavors);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testNullMemInUse() {
        new ResourcesInfo("id", "value1", "value2", "value3",null, flavors);
    }
    
    @Test
    public void testValidValues(){
        ResourcesInfo resources = new ResourcesInfo("id", "value1", "value2", "value3", "value4", flavors);
